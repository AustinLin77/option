<template>
  <div class="addcomplain">
    <div style="position: absolute;bottom: 45px;width: 100%;overflow: scroll;top: 0;">
  ...
  export default {
    ...
    data () {
      return {
        ...
        areas:["工会","欣旺达大学",
//          "培训",
          "欣旺达APP","人才管理","绩效问题","薪资福利","人事服务","招聘调配","员工关系","其他问题"],
        complaintype:[],
        complainmodel:[],
        form:{
          workNo:"",
...
//            break;
          ...
          case  '人才管理':
            ...
            break;
//          case  'HR中心':
//            this.complainmodel=['人才管理'];
//            break;
//          case  '薪资绩效':
//            this.complainmodel=['绩效问题','薪资问题','福利问题'];
//            break;
          case  '绩效问题':
            this.complainmodel=['绩效问题'];
            break;
          case  '薪资福利':
            this.complainmodel=['薪资问题','福利问题'];
            break;
          case  '人事服务':
            this.complainmodel=['入职办理','离职办理','考勤服务','招调工办理（户籍）','社保/公积金办理','意外险问题','其他人事服务'];
            break;
//          case  '人事服务':
//            this.complainmodel=['入职&离职办理','社保/公积金办理','招调工办理（户籍）','意外险','考勤服务','其他人事服务'];
//            break;
